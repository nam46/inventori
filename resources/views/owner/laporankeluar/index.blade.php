        ...
        <div class="col-md-12">
          <div class="box">
            <div class="box-body">
                ...
                @endif
                <form method="get" action="{{ route('owner.laporankeluar.index') }}">
                    <div class="row">
                    <div class="col-md-2">
                    ...
                    <div class="col-md-1">
                        ...
                        <a class="btn btn-primary" href="{{ route('owner.laporankeluar.cetak') }}?start={{ Request::get('start') }}&end={{ Request::get('end') }}&kode={{ Request::get('kode') }}" style="background-color: #c0392b;border:none;"><i class="fa fa-download"></i> Cetak PDF</a>
                        @else
                        <a class="btn btn-primary" href="{{ route('owner.laporankeluar.cetak') }}" style="background-color: #c0392b;border:none;"><i class="fa fa-download"></i> Cetak PDF</a>
                        @endif
