...
<div class="row">
    <div class="col-md-12">
        <div class="box">
          ...
          @endif
          <form class="form-horizontal" method="post" action="{{  route('sekertaris.materialkeluar.store') }}">
            @csrf
            <div class="box-body">
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <input type="number" max="{{ $d->stok_material }}" class="form-control" id="jumlah_material" name="jumlah_material[]" style="width:100px;">
                                  </td>
                                </tr>
                                @php
                                    $angka++;
