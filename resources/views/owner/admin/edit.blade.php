...
<div class="row">
        <div class="col-md-12">
          <div class="box">
            ...
            @endif
            <form class="form-horizontal" method="post" action="{{  route('owner.admin.update', $data->id_admin) }}">
                @method('patch')
              @csrf
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control" id="nama_admin" name="nama_admin" value=" {{ old('nama_admin') ?? $data->nama_admin }} ">
                      </div>
                    </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <textarea class="form-control" id="alamat" name="alamat_admin">{{ old('alamat_admin') ?? $data->alamat_admin }}</textarea>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="no_telfon_admin" name="no_telfon_admin" value="{{ old('no_telfon_admin') ?? $data->no_telfon_admin }}">
                        </div>
                      </div>
